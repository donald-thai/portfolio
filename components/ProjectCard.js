...
const ProjectCard = ({img, title, description, gradient, titleColor, descColor}) => {
  return (
    <div className={`h-[20em] w-full md:h-[35em] lg:h-[45em] lg:w-[45%] rounded-xl flex flex-col ${gradient || "bg-gradient-to-b from-[#004986] to-[#22303c]"} transition duration-500 ease-in-out shadowCard hover:translate-y-[-1em]`}>
